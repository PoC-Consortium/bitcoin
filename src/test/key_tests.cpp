...
#ifdef ENABLE_POCX
static const std::string addr1 = "bbz7XaohRQwxZE9bPECfXs1HGcEdVP9ozp";
static const std::string addr2 = "bSpEmTQjhwU2WUAFFp1Ro8mvY988f37xR8";
static const std::string addr1C = "baXaZ3DNJiZoB39GPBm9WEmBMQKQd42jZe";
static const std::string addr2C = "bQ9ziXJqMXuzW81tR5CoV17ZBFMKwLuYUd";
#else
