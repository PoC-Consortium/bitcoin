                ...
                },
                {
                    RPCResult{"for verbose = true",
                        RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "account_id", "The miner's account address (bech32)"},
                                {RPCResult::Type::STR_HEX, "seed", "The plot seed (32 bytes hex)"},
                                {RPCResult::Type::NUM, "nonce", "The mining nonce"},
                                {RPCResult::Type::NUM, "quality", "Raw quality from proof validation"},
                                {RPCResult::Type::NUM, "compression", "Compression level used for the proof"},
                            }},
                            {RPCResult::Type::STR_HEX, "pubkey", "The block signer's public key"},
                            {RPCResult::Type::STR, "signer_address", /*optional=*/true, "The block signer's address (only present if pubkey is valid)"},
