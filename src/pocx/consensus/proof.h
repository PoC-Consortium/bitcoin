...
enum ValidationError {
    ...
    VALIDATION_ERROR_QUALITY_MISMATCH = -107, // Early surrender: claimed quality != calculated
    VALIDATION_ERROR_COMPRESSION_OUT_OF_RANGE = -108 // compression outside the allocation-safe bound
};
