    ...
    const CCoinsViewCache& view)
{
    ...
    for (const auto& input : tx.vin) {
        ...
        // Check if this is a P2WPKH spending from the plot address.
        // P2WPKH is witness v0 with a 20-byte program (the keyhash).
        const CScript& spk = coin->out.scriptPubKey;
        int wit_version;
        std::vector<unsigned char> wit_program;
        if (spk.IsWitnessProgram(wit_version, wit_program) &&
            wit_version == 0 && wit_program.size() == 20) {
...
// ============================================================================
// Replay-Side Assignment Application
// ============================================================================
