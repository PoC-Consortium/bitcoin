...
// CPU feature detection for Shabal256 SIMD dispatch.
// SSE2: baseline on x86-64, gated by architecture at compile time.
// AVX2: reuses SHA256AutoDetect() result (runs at startup).
