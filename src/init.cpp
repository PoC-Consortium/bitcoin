...
#ifdef ENABLE_POCX
    argsman.AddArg("-miningserver", "Enable mining server mode: allow get_mining_info and submit_nonce RPC methods without authentication, and show Forging Assignment tab in GUI", ArgsManager::ALLOW_ANY, OptionsCategory::RPC);
#endif
