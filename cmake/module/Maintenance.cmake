...
function(add_windows_deploy_target)
  if(MINGW AND TARGET bitcoin AND TARGET bitcoin-qt AND TARGET bitcoind AND TARGET bitcoin-cli AND TARGET bitcoin-tx AND TARGET bitcoin-wallet AND TARGET bitcoin-util AND TARGET test_bitcoin)
    ...
    generate_setup_nsi()
    if(ENABLE_POCX)
      set(WIN_SETUP_NAME "bitcoin-pocx-win64-setup")
    else()
      set(WIN_SETUP_NAME "bitcoin-win64-setup")
    endif()
    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/${WIN_SETUP_NAME}.exe
      ...
      COMMAND ${MAKENSIS_EXECUTABLE} -V2 ${PROJECT_BINARY_DIR}/${WIN_SETUP_NAME}.nsi
      VERBATIM
    )
    add_custom_target(deploy DEPENDS ${PROJECT_BINARY_DIR}/${WIN_SETUP_NAME}.exe)
  endif()
endfunction()
